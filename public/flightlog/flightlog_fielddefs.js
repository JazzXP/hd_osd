...
let FlightLogEvent = makeReadOnly({
    SYNC_BEEP: 0,
  ...
  PID_DELTA_TYPE = makeReadOnly(["ERROR", "MEASUREMENT"]),
  ...
  DTERM_DIFFERENTIATOR = makeReadOnly(["STANDARD", "ENHANCED"]),
  ...
  GYRO_HARDWARE_LPF = makeReadOnly(["NORMAL", "EXPERIMENTAL", "1KHZ_SAMPLING"]),
  ...
  BARO_HARDWARE = makeReadOnly(["AUTO", "NONE", "BMP085", "MS5611", "BMP280"]),
  MAG_HARDWARE = makeReadOnly(["AUTO", "NONE", "HMC5883", "AK8975", "AK8963"]),
  ...
  DYN_NOTCH_RANGE = makeReadOnly(["HIGH", "MEDIUM", "LOW", "AUTO"]),
