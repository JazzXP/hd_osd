...
const { ArrayDataStream } = require("./datastream");
const {asciiArrayToString, stringHasComma, parseCommaSeparatedString,hexToFloat,signExtend14Bit, uint32ToFloat, asciiStringToByteArray} = require('./tools')
const {adjustFieldDefsList, FlightLogEvent,   FIRMWARE_TYPE_UNKNOWN,
...
const FlightLogParser = function (logData) {
  //Private constants:
  const //FLIGHT_LOG_MAX_FIELDS = 128,
